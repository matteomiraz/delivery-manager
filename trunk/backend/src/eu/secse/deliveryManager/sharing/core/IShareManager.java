...
import eu.secse.deliveryManager.core.GenericProxy;
...
@Local
public interface IShareManager extends GenericProxy {
	...
	public void received(DService dService) throws NotFoundException;

	public void received(FacetAddInfo facetAddInfo);
}
