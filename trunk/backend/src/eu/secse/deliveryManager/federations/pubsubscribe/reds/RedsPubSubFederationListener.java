...
package eu.secse.deliveryManager.federations.pubsubscribe.reds;
...
public class RedsPubSubFederationListener extends ARedsListener {
	
	private static final Log log = LogFactory.getLog(RedsPubSubFederationListener.class);
	
	//private IPubSubProxyMBean coordinator;
	
	private static final String QUEUE_REDS = "queue/pubsubfed";
	
	
	public RedsPubSubFederationListener() {
//		try {
