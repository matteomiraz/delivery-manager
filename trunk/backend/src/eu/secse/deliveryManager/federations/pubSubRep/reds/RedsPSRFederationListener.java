...
public class RedsPSRFederationListener extends ARedsReplyListener {
	
	private static final Log log = LogFactory.getLog(RedsPSRFederationListener.class);
	
	//private IPubSubProxyMBean coordinator;
	
	private static final String QUEUE_REDS = "queue/pubsubrepfed";
	
	public RedsPSRFederationListener() { }
