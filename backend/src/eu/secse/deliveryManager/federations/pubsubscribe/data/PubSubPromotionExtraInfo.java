...
@Entity
@NamedQueries(value={
		@NamedQuery(name=PubSubPromotionExtraInfo.FEDERATED_ELEMENT_TO_RENEW, 
				query="SELECT f.prom FROM PubSubPromotionExtraInfo AS f WHERE f.timeout < current_timestamp() ")
})
public class PubSubPromotionExtraInfo extends FederatedPromotionExtraInfo {
	
	public static final String FEDERATED_ELEMENT_TO_RENEW = "FederatedElementToExpire";
	
	public PubSubPromotionExtraInfo(){
		super();
	}
