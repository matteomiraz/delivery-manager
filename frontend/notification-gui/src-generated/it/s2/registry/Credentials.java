...
public class Credentials  implements java.io.Serializable {
    ...
    /**
     * Gets the login value for this Credentials.
     * 
     * @return login
     */
    ...
    /**
     * Sets the login value for this Credentials.
     * 
     * @param login
     */
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://registry.s2.it", "Credentials"));
