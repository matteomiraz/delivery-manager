...
/** Removes delivery managers from the partial view when their subscription expires 
 * 
 * @author ercasta
 *
 */
@Local
public interface IPartialViewCleaner {
	
	/** Create a new timer for the specified federation.
	 * 
	 * @param federationid
	 */	
