...
public class HeartBeatMessage extends AbstractMessage {
	...
	public HeartBeatMessage(String src, String dest, String federation) {
		super(src, dest, federation);
	}

	private static final long serialVersionUID = -5776910694667231585L;

	public Message createCopy(String destination) {
		return new HeartBeatMessage(getSender(),destination,getFederationId());
	}
