...
@Stateless
public class FedSecPsExpire implements IFedSecPsExpire {
	private static final Log log = LogFactory.getLog(IFedSecPsExpire.class);
	...
	private void deleteFederatedElements() {
		...
		Collection<FederatedElement> felems = SecPubSubFedElemExtraInfo.getExpired(this.em);
