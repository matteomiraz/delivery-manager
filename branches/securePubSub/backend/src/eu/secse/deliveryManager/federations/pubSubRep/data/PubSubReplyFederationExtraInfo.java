...
package eu.secse.deliveryManager.federations.pubSubRep.data;
 ...
 */
@Entity
public class PubSubReplyFederationExtraInfo extends FederationExtraInfo{
	
	@Lob
	private InterestEnvelope federationFilter;

	public PubSubReplyFederationExtraInfo() {
		super();		
	}
	...
	public PubSubReplyFederationExtraInfo(InterestEnvelope federationFilter) {
		super();
		this.federationFilter = federationFilter;
	}
	...
	public static Collection<PubSubReplyFederationExtraInfo> getAll(EntityManager em){
		return em.createQuery("FROM PubSubReplyFederationExtraInfo").getResultList();
	}
}
