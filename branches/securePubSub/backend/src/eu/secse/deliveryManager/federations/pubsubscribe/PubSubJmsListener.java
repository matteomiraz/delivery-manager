...
package eu.secse.deliveryManager.federations.pubsubscribe;
...
@MessageDriven(activationConfig = {
		...
		@ActivationConfigProperty(propertyName = "destination", propertyValue = "queue/pubsubfed")
	})
public class PubSubJmsListener implements MessageListener {
	
	private static final Log log = LogFactory.getLog(PubSubJmsListener.class);
