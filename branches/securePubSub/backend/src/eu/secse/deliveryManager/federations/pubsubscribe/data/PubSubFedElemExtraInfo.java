...
@Entity
@NamedQueries(value={
		@NamedQuery(name=PubSubFedElemExtraInfo.FEDERATED_ELEMENT_EXPIRED, query="SELECT f.elem FROM PubSubFedElemExtraInfo AS f WHERE f.timeout < current_timestamp() ")
})
public class PubSubFedElemExtraInfo extends FederatedElementExtraInfo{
	...
	public PubSubFedElemExtraInfo() {
		super();
	}
	
	@SuppressWarnings("unchecked")
	public static Collection<FederatedElement> getExpired(EntityManager em){
		return em.createNamedQuery(PubSubFedElemExtraInfo.FEDERATED_ELEMENT_EXPIRED).getResultList();
	}
